public class FootballMatch {
	public static void main(String[] args) {
		FootballMatch test = new FootballMatch();
		int outScore = test.footballMatch(2, 4, 5, 6);
		System.out.println(outScore);
	}

	public int footballMatch(int matchScore1, int matchScore2, int yourScore1, int yourScore2) {
		// exc 1.1
